...
function cardsFromOperationalBundle(bundle: OperationalSignalsBundle | null): ReasoningCardVm[] {
  ...
  const cards: ReasoningCardVm[] = [
    ...
    },
    {
      ...
      subtitle: `recovery/bio ${nut.trainingEnergyScale.toFixed(2)}x · protein +${nut.proteinBiasPctPoints.toFixed(1)} pt`,
      tone: "cyan",
      status: "computed",
      confidence: null,
      explanation:
        "I dial nutrizione modulano distribuzione pasti↔fueling, CHO/h, proteine e idratazione sulla base dello stesso bundle usato da training. Il fabbisogno energetico totale del giorno resta BMR + lifestyle + training pianificato (eseguito quando importato): l'indicatore recovery/bio non lo riduce.",
