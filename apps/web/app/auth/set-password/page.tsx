  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-zinc-950 px-6 py-16 text-white">
      <div className="text-center">
        ...
        <h1 className="mt-3 text-xl font-bold tracking-tight">Set a new password</h1>
        <p className="mt-2 max-w-sm text-sm text-gray-400">
          Choose a strong password (at least 8 characters). Once saved, you&apos;ll enter the app.
        </p>
      </div>
      <AuthSetPasswordForm />
    </main>
