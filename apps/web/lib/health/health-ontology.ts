...
export const HEALTH_MARKERS: HealthMarkerDefinition[] = [
  /** Prima HbA1c poi emoglobina: evita che alias corti tipo «Hb» matchino sulla riga HbA1c. */
  { key: "hba1c", panelType: "blood", label: "HbA1c", aliases: ["hba1c", "hb a1c", "hba 1c", "emoglobina glicata", "glycated hemoglobin", "a1c"], unit: "%" },
  {
    key: "emoglobina",
    panelType: "blood",
    label: "Emoglobina",
    aliases: ["emoglobina", "emo.", "hemoglobin", "hgb", "hb corp.", "hb corpusc.", "hb corpuscolare"],
    unit: "g/dL",
  },
  {
    key: "rbc",
  ...
  },
  {
    ...
    panelType: "blood",
    label: "Ematocrito",
    aliases: ["ematocrito", "ematocrito (ht)", "hematocrit", "hct", "htc", "ht ", " ht ", "ht:", "htc:"],
    unit: "%",
  },
  {
    key: "mcv",
    panelType: "blood",
    label: "MCV",
    aliases: ["mcv", "vcm", "volume corpuscolare medio", "mean corpuscular volume"],
    unit: "fL",
  },
  {
    key: "mch",
    panelType: "blood",
    label: "MCH",
    aliases: ["mch", "ccmh", "contenuto corpuscolare medio di hb", "contenuto emoglobinico medio"],
    unit: "pg",
  },
  {
    key: "mchc",
    panelType: "blood",
    label: "MCHC",
    aliases: ["mchc", "ccmhc", "concentrazione emoglobinica corpuscolare media", "concentrazione corpuscolare media di hb"],
    unit: "g/dL",
  },
  {
    key: "plt",
  ...
  { key: "rdw", panelType: "blood", label: "RDW", aliases: ["rdw", "rdw-cv", "ampiezza distribuzione eritrocitaria"], unit: "%" },
  { key: "ferritina", panelType: "blood", label: "Ferritina", aliases: ["ferritina", "ferritin", "ferritina sierica"], unit: "ng/mL" },
  {
    key: "vit_d",
    panelType: "blood",
    label: "Vitamina D",
    aliases: ["vitamina d", "25-oh vitamina d", "25 oh vitamina d", "vitamin d", "25-oh", "25 oh", "25-hydroxy", "calcidiolo", "25(oh)d"],
    unit: "ng/mL",
  },
  {
    key: "b12",
    panelType: "blood",
    label: "Vitamina B12",
    aliases: ["vitamina b12", "vit b12", "cobalamina", "cobalamin", "b12"],
    unit: "pg/mL",
  },
  {
    key: "glicemia",
    panelType: "blood",
    label: "Glicemia",
    aliases: ["glicemia", "glucosio", "glycemia", "glucose", "fasting glucose", "glicemia a digiuno"],
    unit: "mg/dL",
  },
...
export const MICROBIOTA_TAXA: MicrobiotaTaxonDefinition[] = [
  {
    key: "firmicutes",
    label: "Firmicutes",
    aliases: ["firmicutes", "firmicuti", "phylum firmicutes", "filum firmicutes", "famiglia firmicutes", "divisione firmicutes"],
    rank: "phylum",
    kind: "bacteria",
  },
  {
    key: "bacteroidetes",
    label: "Bacteroidetes",
    aliases: ["bacteroidetes", "batteroideti", "phylum bacteroidetes", "filum bacteroidetes", "famiglia bacteroidetes"],
    rank: "phylum",
    kind: "bacteria",
  },
  {
    ...
    aliases: ["proteobacteria", "proteobatteri", "phylum proteobacteria", "filum proteobacteria"],
    rank: "phylum",
    kind: "bacteria",
  },
  {
    ...
    aliases: ["actinobacteria", "attinobatteri", "phylum actinobacteria", "filum actinobacteria"],
    rank: "phylum",
    kind: "bacteria",
  },
  { key: "verrucomicrobia", label: "Verrucomicrobia", aliases: ["verrucomicrobia", "phylum verrucomicrobia"], rank: "phylum", kind: "bacteria" },
  { key: "fusobacteria", label: "Fusobacteria", aliases: ["fusobacteria", "phylum fusobacteria"], rank: "phylum", kind: "bacteria" },
  ...
  { key: "faecalibacterium", label: "Faecalibacterium", aliases: ["faecalibacterium", "f. prausnitzii", "prausnitzii"], rank: "genus", kind: "bacteria" },
  {
    ...
    aliases: ["lachnospiraceae", "lachnospiracee", "fam. lachnospiraceae", "famiglia lachnospiraceae", "family lachnospiraceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    ...
    aliases: ["ruminococcaceae", "ruminococcacee", "fam. ruminococcaceae", "famiglia ruminococcaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    ...
    aliases: ["bacteroidaceae", "bacteroidacee", "fam. bacteroidaceae", "famiglia bacteroidaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    ...
    aliases: ["prevotellaceae", "prevotellacee", "fam. prevotellaceae", "famiglia prevotellaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    key: "enterobacteriaceae",
    label: "Enterobacteriaceae",
    aliases: ["enterobacteriaceae", "enterobacteriacee", "fam. enterobacteriaceae", "famiglia enterobacteriaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    key: "veillonellaceae",
    label: "Veillonellaceae",
    aliases: ["veillonellaceae", "veillonellacee", "fam. veillonellaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    key: "erysipelotrichaceae",
    label: "Erysipelotrichaceae",
    aliases: ["erysipelotrichaceae", "erysipelotrichacee", "fam. erysipelotrichaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    key: "fusobacteriaceae",
    label: "Fusobacteriaceae",
    aliases: ["fusobacteriaceae", "fusobacteriacee", "fam. fusobacteriaceae"],
    rank: "family",
    kind: "bacteria",
  },
  {
    key: "porphyromonadaceae",
    label: "Porphyromonadaceae",
    aliases: ["porphyromonadaceae", "porphyromonadacee", "fam. porphyromonadaceae"],
    rank: "family",
    kind: "bacteria",
  },
